...
This is a Todo List project from the [Odin Project](https://www.theodinproject.com/lessons/node-path-javascript-todo-list) course. It allows users to create, manage, and organize tasks and projects. View the [Live Demo](https://admyazeed.github.io/todo-list/).
